...
import 'package:weather/screens/weatherInfo.dart';
import 'package:weather/model/models.dart';
import 'package:weather/model/weatherModel.dart';
import 'package:shared_preferences/shared_preferences.dart';
import 'package:intl/intl.dart';
import 'package:weather/api/callApi.dart';
...
class _CityListState extends State<CityList> {
  ...
  Future<WeatherResponse> getWeather(long, lat) async {
    final response = await http.get(Uri.parse(
        'https://api.openweathermap.org/data/2.5/weather?&lon=$long&lat=$lat&appid=d89566b7541ecad9d211291d677951ba&units=metric&lang=vi'));
  ...
  Future<Object> fetchWeather() async {
    ...
    final response = await http.get(Uri.parse(
        'http://api.openweathermap.org/data/2.5/group?id=$cittiesIds&APPID=d89566b7541ecad9d211291d677951ba&units=metric&lang=vi'));
                                      ...
                                      child: Padding(
                                        ...
                                        child: Card(
                                          ...
                                          child: Stack(
                                              ...
                                              children: [
                                                weatherCondition(
                                                    '${cityWeather[cityIndex].cityIcon}'),
                                                Ink.image(
                                                  image: AssetImage(
                                                      'assets/images/bgr.png'),
                                                  height: 115,
                                      ...
                                      child: Center(
                                        child: Card(
                                          ...
                                          child: Stack(
                                              ...
                                              children: [
                                                weatherCondition(
                                                    '${cityWeather[cityIndex].cityIcon ?? '01d'}'),
                                                Ink.image(
                                                  image: AssetImage(
                                                      'assets/images/bgr.png'),
                                                  height: 115,
...
class _UnixTimestampClockState extends State<UnixTimestampClock> {
  ...
  void initState() {
    ...
    _timer = Timer.periodic(Duration(seconds: 20), _updateDateTime);
  }
