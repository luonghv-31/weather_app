...
import 'package:weather/model/models.dart';
import 'package:weather/model/weatherModel.dart';
import 'package:weather/model/weatherCurrentModel.dart';
import 'package:weather/model/weatherDailyModel.dart';
import 'package:weather/model/weatherHourlyModel.dart';
import 'package:weather/model/weatheralertsModel.dart';
import 'dart:convert';
...
class _HomePageState extends State<HomePage> {
  ...
  Future<Object> fetchWeather(lat, lon) async {
    final response = await http.get(Uri.parse(
        'https://api.openweathermap.org/data/2.5/onecall?lat=$lat&lon=$lon&exclude=minutely&appid=0b9cfb0ce1d82a56160219ff893bbc96&units=metric&lang=vi'));
  ...
  String getTime(final timeStamp) {
    ...
    String y = DateFormat.H().format(timee);
    // print(timee);
    print(y);
    return y == x ? "Bây giờ" : x;
  }
                  ...
                  itemBuilder: (ctx, i) {
                    if (i == 0 && widget.loc) {
                      return Scaffold(
                        ...
                        weatherCondition2('${_response!.weatherInfo.icon}'),
                        NestedScrollView(
                                                                  ...
                                                                  return Container(
                                                                    ...
                                                                    child:
                                                                      ...
                                                                      children: [
                                                                        Column(
                                                                          children: [
                                                                            Text(getTime(cityWeatherHr[index].dt),
                                                                                ...
                                                                                if (cityWeatherHr[index].rain! > 9) ...{
                                                                                  Container(
                                                                                    ...
                                                                                    child: Padding(
                                                                                      ...
                                                                                      child: Text(
                                                                                        cityWeatherHr[index].rain!.toStringAsFixed(0) + '%',
                                                                                        style: TextStyle(color: Colors.lightBlue, fontSize: 13, fontWeight: FontWeight.w800),
                                                                                      ),
                                                                                    ),
                                                                                  )
                                                                                },
                      ...
                      return Scaffold(
                          body: Stack(fit: StackFit.expand, children: [
                        weatherCondition2('${cityWeather[cityIndex].cityIcon}'),
                        NestedScrollView(
                            controller: _scrollControllers[i],
                            headerSliverBuilder: (context, innerBoxIsScrolled) {
                              return [
                                                                      ...
                                                                      Container(
                                                                        ...
                                                                        child:
                                                                          ...
                                                                          children: [
                                                                            ...
                                                                            //          
                                                                                // if (cityWeatherDy[index].tempmax >9 && cityWeatherDy[index].tempmin > 9   ) ...{
                                                                                //   Container(
                                                                                //     padding: EdgeInsets.all(0),
                                                                                //     decoration: BoxDecoration(
                                                                                //       borderRadius: BorderRadius.circular(5),
                                                                                ...
                                                                                //   )
                                                                                // },
                                                                                if (int.parse(cityWeatherDy[index].tempmax.toStringAsFixed(0)) <10 && int.parse(cityWeatherDy[index].tempmin.toStringAsFixed(0)) < 10 &&int.parse(cityWeatherDy[index].tempmax.toStringAsFixed(0)) >-1 && int.parse(cityWeatherDy[index].tempmin.toStringAsFixed(0)) >-1  ) ...{
                                                                                  Container(
                                                                                    padding: EdgeInsets.all(0),
                                                                                    decoration: BoxDecoration(
                                                                                      borderRadius: BorderRadius.circular(5),
                                                                                ...
                                                                                if (int.parse(cityWeatherDy[index].tempmax.toStringAsFixed(0)) >9 && int.parse(cityWeatherDy[index].tempmin.toStringAsFixed(0)) < 10 &&int.parse(cityWeatherDy[index].tempmax.toStringAsFixed(0)) >-1 && int.parse(cityWeatherDy[index].tempmin.toStringAsFixed(0)) >-1  ) ...{
                                                                                  Container(
                                                                                    padding: EdgeInsets.all(0),
                                                                                    decoration: BoxDecoration(
                                                                                      borderRadius: BorderRadius.circular(5),
                                                                                 ...
                                                                                 if (int.parse(cityWeatherDy[index].tempmax.toStringAsFixed(0)) <10  && int.parse(cityWeatherDy[index].tempmin.toStringAsFixed(0)) >-10  ) ...{
                                                                                  Container(
                                                                                    padding: EdgeInsets.all(0),
                                                                                    decoration: BoxDecoration(
                                                                                      borderRadius: BorderRadius.circular(5),
                                                                                ...
                                                                                if (int.parse(cityWeatherDy[index].tempmax.toStringAsFixed(0)) >9 && int.parse(cityWeatherDy[index].tempmin.toStringAsFixed(0)) > 9   ) ...{
                                                                                  Container(
                                                                                    padding: EdgeInsets.all(0),
                                                                                    decoration: BoxDecoration(
                                                                                      borderRadius: BorderRadius.circular(5),
                                                                                ...
                                                                                // if (int.parse(cityWeatherDy[index].tempmax.toStringAsFixed(0)) >9 && int.parse(cityWeatherDy[index].tempmin.toStringAsFixed(0)) < 10      ) ...{
                                                                                //   Container(
                                                                                //     padding: EdgeInsets.all(0),
                                                                                //     decoration: BoxDecoration(
